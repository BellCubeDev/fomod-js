import { TagName, Verifiable, XmlRepresentation } from "../..";
...
class MockXMLRepresentation extends XmlRepresentation<true> {
    ...
    reasonForInvalidity(...tree: Omit<Verifiable<false>, "isValid" | "reasonForInvalidity">[]): import("../..").InvalidityReport | null {
        throw new Error("Method not implemented.");
    }
